...
(function ($) {
    ...
    var isIE = function (ver) {
        ...
        defaultFileActionSettings = {
            ...
            removeClass: 'btn btn-sm btn-danger btn-block',
            removeTitle: 'Remove file',
            uploadIcon: '<i class="fa fa-cloud-upload text-success"></i>',
            uploadClass: 'btn btn-sm btn-default btn-block',
            uploadTitle: 'Upload file',
            indicatorNew: '<i class="fa fa-clock-o text-warning"></i>',
            indicatorSuccess: '<i class="fa fa-check-circle-o text-success"></i>',
            indicatorError: '<i class="fa fa-warning text-danger"></i>',
            indicatorLoading: '<i class="fa fa-cloud-upload text-muted"></i>',
    ...
    FileInput.prototype = {
        ...
        parseError: function (jqXHR, errorThrown, fileName) {
            ...
            return fileName ? '<b>' + fileName + ': </b><br>' + errMsg : errMsg;
        },
        ...
        setProgress: function (p) {
            ...
            if( pct == 100){ self.$progress.addClass('hide'); }
        },
        upload: function () {
        ...
        showUploadError: function (msg, params, event) {
            ...
            if ($error.find('ul').length === 0) {
                $error.html('<ul style="cursor:pointer; list-style: outside none none; padding-left: 0px; text-align: center;"><li>' + msg + '</li></ul>');
            } else {
        ...
        renderBrowse: function () {
            var self = this, css = self.browseClass + ' btn-file btn-block', status = '';
            if (self.isDisabled) {
                status = ' disabled ';
            }
        ...
        renderCancel: function () {
            var self = this, css = self.cancelClass + ' fileinput-cancel fileinput-cancel-button btn-block';
            if (!self.showCancel) {
                return '';
            }
        ...
        renderUpload: function () {
            var self = this, css = self.uploadClass + ' kv-fileinput-upload fileinput-upload-button btn-block', content = '', status = '';
            if (!self.showUpload) {
                return '';
            }
            if (self.isDisabled) {
    ...
    $.fn.fileinput.defaults = {
        ...
        cancelIcon: '<i class="fa fa-ban text-danger"></i> ',
